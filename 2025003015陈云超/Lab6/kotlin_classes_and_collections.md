...
fun main() {
    // 测试代码
    val event = Event("学习Kotlin", null, "Morning", 30)
    println(event)
}
```
...
data class Event(
    val title: String,
    val description: String? = null,
    val daypart: Daypart,  // 改为枚举类型
    val durationInMinutes: Int
)

fun main() {
    val event = Event("学习Kotlin", null, Daypart.MORNING, 30)
    println(event)
}
```
...
fun main() {
    ...
    groupedEvents.forEach { (daypart, eventsList) ->
